...
namespace VideoJockey.PasswordReset;

class Program
{
    static async Task<int> Main(string[] args)
    {
        Console.WriteLine("VideoJockey Password Reset Utility");
        Console.WriteLine("===================================\n");
        ...
        if (string.IsNullOrWhiteSpace(dbPath))
        {
            ...
            if (parentDir != null)
            {
                dbPath = Path.Combine(parentDir, "VideoJockey.Web", "data", "videojockey.db");
            }

            if (string.IsNullOrWhiteSpace(dbPath) || !File.Exists(dbPath))
            {
                dbPath = Path.Combine("data", "videojockey.db");
            }
        }
    ...
    static void ShowUsage()
    {
        ...
        Console.WriteLine("  VideoJockey.PasswordReset --username <username> --password <password> [--database <path>]");
        Console.WriteLine();
        ...
        Console.WriteLine("  -d, --database <path>        Path to videojockey.db (optional)");
        Console.WriteLine("  -h, --help                   Show this help message");
        Console.WriteLine();
        Console.WriteLine("Examples:");
        Console.WriteLine("  VideoJockey.PasswordReset --username admin --password NewPassword123");
        Console.WriteLine("  VideoJockey.PasswordReset -u admin -p MySecurePass2024 -d /path/to/videojockey.db");
        Console.WriteLine();
    }
}
