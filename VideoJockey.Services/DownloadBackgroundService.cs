...
using ServicesDownloadQueueService = VideoJockey.Services.Interfaces.IDownloadQueueService;
    ...
    public class DownloadBackgroundService : BackgroundService
    {
        ...
        private async Task ProcessQueueItemAsync(Guid queueId, CancellationToken stoppingToken)
        {
            ...
            try
            {
                ...
                var progress = new Progress<VideoJockey.Core.Interfaces.DownloadProgress>(p =>
                {
