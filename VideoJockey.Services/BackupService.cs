...
/// <summary>
/// Provides backup and restore functionality for the VideoJockey SQLite database.
/// </summary>
public sealed class BackupService : IBackupService
{
    ...
    public async Task<BackupResult> CreateBackupAsync(CancellationToken cancellationToken = default)
    {
        ...
        var backupFileName = $"videojockey-backup-{timestamp:yyyyMMddHHmmss}.zip";
    ...
    public async Task RestoreBackupAsync(Stream backupStream, CancellationToken cancellationToken = default)
    {
        ...
        var tempRestoreDirectory = Path.Combine(databaseDirectory, $".videojockey-restore-{Guid.NewGuid():N}");
